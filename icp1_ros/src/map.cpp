...
class map_node : public rclcpp::Node
{
    ...
    :  Node("map_node"), map_width(200), map_height(200), map_resolution(0.1), origin_x(-10.0), origin_y(-10.0)
    {
        ...
        pointcloud_sub = this->create_subscription<sensor_msgs::msg::PointCloud2>(
            "map_point",  rclcpp::QoS(10),
            std::bind(&map_node::pointcloud_callback, this, std::placeholders::_1));
    ...
    void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
    {
        ...
        for (; iter_x != iter_x.end(); ++iter_x, ++iter_y, ++iter_z)
        {
            ...
            int mx = static_cast<int>((x - origin_x) / map_resolution);
            int my = static_cast<int>((y - origin_y) / map_resolution);
